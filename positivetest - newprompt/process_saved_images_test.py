               ...
               try:
                   ...
                   for filem in range(filen+1,len(files)):
                       ...
                       if webcamid==os.path.basename(newfile).split("_")[0]: #we have a second image for this webcam
                           ...
                           isUnusual=classify_desc("Read the description below and say DETECT (and nothing else) if it describes at least slightly unusual aircraft or at least slightly unusual unusual phenomena present in the sky . Say NODETECT and nothing else if there are no unusual aircraft or unusual phenomena present in the sky. :\n"+result)                       
                           print(isUnusual)
                           print(result)
